    ...
    <>
      <CastmateLayout>
        <Community title="Home">
          <ControlList>
            <MainItem href="/" icon={<Tv size={22} />} title="New room" description="set up new room" />
            <MainItem href="/" icon={<PlusSquare size={22} />} title="Join room" description="via invitation link" />
          </ControlList>
        </Community>
      </CastmateLayout>
    </>
